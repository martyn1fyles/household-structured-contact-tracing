...
def run_simulation(repeat):
    ...
    do_2_step = False # npr.choice([True, False])

    prob_has_trace_app = npr.uniform(0, 0.5)

    trace_all_hh_members_upon_discovery = npr.choice([True, False])

    if trace_all_hh_members_upon_discovery:
    ...
    parameters = [
        ...
        do_2_step,
        prob_has_trace_app,
        trace_all_hh_members_upon_discovery
    ]
...
if __name__ == '__main__':
    with Pool(10) as p:
        ...
        results.to_excel("Data/Simulation Results/comparing_immediate_tracing_all_household_members.xlsx")
