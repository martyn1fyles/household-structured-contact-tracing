...
def run_simulation(repeat):
    ...
    backwards_tracing_time_limit = npr.choice(list(range(number_of_days_to_trace_backwards, 35)))
...
if __name__ == '__main__':
    with Pool(10) as p:
        ...
        results.to_excel("backwards tracing pars frozen high twostep.xlsx")
